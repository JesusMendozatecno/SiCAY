...
$registros = mysqli_query($con, "
    ...
    LEFT JOIN medicion_horaria m1 ON m1.id_registro_diario = rd.id AND m1.id_parametro = 13
    LEFT JOIN medicion_horaria m2 ON m2.id_registro_diario = rd.id AND m2.id_parametro = 14
            ...
            <table class="tabla">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo number_format($r['nivel'], 2); ?></td>
                        <td><?php echo number_format($r['presion'], 1); ?></td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
