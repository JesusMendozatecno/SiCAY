...
if ($result->num_rows === 0) {
    $_SESSION['reset_msg'] = ['tipo' => 'error', 'texto' => 'No existe una cuenta con ese correo electrónico.', 'link' => ''];
    $stmt->close();
    redirigir('olvide_pass');
}
$stmt->close();
...
try {
    ...
    <div style="font-family:Arial;max-width:500px;margin:auto;padding:30px;background:#f4f7fc;border-radius:15px;">
        ...
        <div style="background:white;padding:25px;border-radius:12px;">
            ...
            <p style="color:#555;">Haz clic en el siguiente boton para restablecer tu contraseña:</p>
