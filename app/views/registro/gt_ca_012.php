...
$registros = mysqli_query($con, "
    ...
    LEFT JOIN medicion_horaria m1 ON m1.id_registro_diario = rd.id AND m1.id_parametro = 22
    LEFT JOIN medicion_horaria m2 ON m2.id_registro_diario = rd.id AND m2.id_parametro = 23
    LEFT JOIN medicion_horaria m3 ON m3.id_registro_diario = rd.id AND m3.id_parametro = 24
            ...
            <table class="tabla">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo number_format($r['combustible'], 0); ?>%</td>
                        <td><?php echo number_format($r['bateria'], 1); ?></td>
                        <td><?php echo number_format($r['temp'], 1); ?></td>
